...
public class AWarpShop {

    private Config config;
    private Messages messages;
    private Message message;
    public AWarpShop(Config config, Messages messages, Message message) {
        this.config = config;
        this.messages = messages;
        this.message = message;

    }
    private Inventory inv = Bukkit.createInventory(null, 45, "§6§lVAGT§f§l WARPSHOP - §A§lA");
    @Utility
    public void items(final Player player) {
        ...
        item = itemStackManager.itemMaker("§a" + config.getConfig().getString("VagtWarp.A.VagtWarp2"), Material.SIGN, 1, 0, loreManager.loreMaker(
                "§8§m-----------------------------",
                "",
                "§7Klik her for at købe",
                "§a" + config.getConfig().getString("VagtWarp.A.VagtWarp2"),
                "",
                "§7Pris§8: §f$" + config.getConfig().getInt("VagtWarpShop.A.VagtWarp2"),
                "",
                "§8§m-----------------------------"));
        inv.setItem(19, item);
        item = itemStackManager.itemMaker("§a" + config.getConfig().getString("VagtWarp.A.VagtWarp3"), Material.SIGN, 1, 0, loreManager.loreMaker(
                "§8§m-----------------------------",
                "",
                "§7Klik her for at købe",
                "§a" + config.getConfig().getString("VagtWarp.A.VagtWarp3"),
                "",
                "§7Pris§8: §f$" + config.getConfig().getInt("VagtWarpShop.A.VagtWarp3"),
                "",
                "§8§m-----------------------------"));
        inv.setItem(21, item);
        item = itemStackManager.itemMaker("§a" + config.getConfig().getString("VagtWarp.A.VagtWarp4"), Material.SIGN, 1, 0, loreManager.loreMaker(
                "§8§m-----------------------------",
                "",
                "§7Klik her for at købe",
                "§a" + config.getConfig().getString("VagtWarp.A.VagtWarp4"),
                "",
                "§7Pris§8: §f$" + config.getConfig().getInt("VagtWarpShop.A.VagtWarp4"),
                "",
                "§8§m-----------------------------"));
        inv.setItem(23, item);
        item = itemStackManager.itemMaker("§a" + config.getConfig().getString("VagtWarp.A.VagtWarp5"), Material.SIGN, 1, 0, loreManager.loreMaker(
                "§8§m-----------------------------",
                "",
                "§7Klik her for at købe",
                "§a" + config.getConfig().getString("VagtWarp.A.VagtWarp5"),
                "",
                "§7Pris§8: §f$" + config.getConfig().getInt("VagtWarpShop.A.VagtWarp5"),
                "",
                "§8§m-----------------------------"));
        inv.setItem(25, item);
